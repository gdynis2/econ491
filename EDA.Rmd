...
We made a graph of total sales by state to identify which state is selling the most. As seen above, we find that California is selling the most. One reason could be that, Californian's have a higher income and are able to purchase more product. But a closer look at the dataset reveals that, the dataset has 4 stores for California and 3 for Texas and Wisconsin. This is also verified in the next graph. 
